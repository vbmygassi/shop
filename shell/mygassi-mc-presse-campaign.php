...
logger("Starting: mygassi-mc-presse-campaign.php");

$coll = Mage::getModel("salesrule/rule")->getCollection();
$campId = null;
foreach($coll as $camp){
	if(false !== strpos($camp->getName(), "Presse")){
		$campId = $camp->getId();
	}
}

if(null === $campId){
	logger("No-Presse-Campaign");
	exit(1);
}
...
$opts['list_id'] = PressListId;
$opts['subject'] = '20% Rabatt für die Presse!';
...
$opts['title'] = '20% Rabatt für die Presse!';

$message = 'Herzlichen Glückwunsch zu Ihrem persönlichen Presse-Rabatt-Coupon, einzulösen mit dem Gutschein "'.$code.'" bei Ihrem nächsten Einkauf im MyGassi Shop! ';
...
logger("Done: mygassi-mc-presse-campaign.php");
