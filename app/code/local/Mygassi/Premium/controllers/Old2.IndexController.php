...
/*
	...
	todo:
		was ist expireajax ? nur aus dem browzer bestimmt....
		wieder einfügen
 */
...
//            $data = $this->_filterPostData($postData);
		...
		// todo: passwords
		$password = "generatedsecretforthepayonegateway";
		...
		/*	
		try{	
			$customer = $customer->loadByEmail($data["email"]);
		}
		catch(Exception $e){
			print_r($e->getMessage());
		}
		*/
		...
		try{
			$res = Mage::getSingleton("customer/session")->login($data["email"], $password);
			$res = Mage::getSingleton("customer/session")->setCustomerAsLoggedIn($customer);
		}
		catch(Exception $e){
			print_r($e->getMessage());
		}
